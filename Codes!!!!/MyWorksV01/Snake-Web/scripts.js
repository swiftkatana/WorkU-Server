        ...
        UpdateBody = () => {
            if (countpoint > 0) {
                for (let i = 1; i <= countpoint; i++) {
                    ...
                    let yB = XAndY[1];
                    if (this.upDown == true)
                        if (i == 1) { body.style.backgroundImage = "url('assets/img/body2W.png')" }
                    if (this.upDown == false)
                        if (i == 1) { body.style.backgroundImage = "url('assets/img/body2S.png')" }
                    if (this.leftright == true)
                        if (i == 1) { body.style.backgroundImage = "url('assets/img/body2D.png')" }
                    if (this.leftright == false)
                        if (i == 1) { body.style.backgroundImage = "url('assets/img/body2A.png')" }
        ...
        Logic = (d) => {
            ...
            if (d == "d" && this.X < 1000) {
                ...
                if (tag == undefined) {
                    ...
                    this.myElement.style.backgroundImage = "url('assets/img/snakeD.png')";
                ...
                if (tag == undefined) {
                    ...
                    this.myElement.style.top = this.y + "px";
                    this.moves.push(this.CreateStringXY(this.X, this.y))
                    this.myElement.style.backgroundImage = "url('assets/img/snakeA.png')";
                } else { this.HitFuns(tag); }
                ...
                if (tag == undefined) {
                    ...
                    this.myElement.style.top = this.y + "px";
                    this.moves.push(this.CreateStringXY(this.X, this.y))
                    this.myElement.style.backgroundImage = "url('assets/img/snakeW.png')";
                } else { this.HitFuns(tag); }
                ...
                if (tag == undefined) {
                    ...
                    this.myElement.style.top = this.y + "px";
                    this.moves.push(this.CreateStringXY(this.X, this.y))
                    this.myElement.style.backgroundImage = "url('assets/img/snakeS.png')";
                } else {
                    this.HitFuns(tag);
                }
